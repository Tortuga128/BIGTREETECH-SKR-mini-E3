...
//#define PSU_NAME "Power Supply"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define POWER_TIMEOUT              60*5 // (s) Turn off power if the machine is idle for this duration
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PULLDOWN           // Use internal pulldown for filament runout pins. **Use with High runout state ? pirtle
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 750
